...
public class PrdClsDAO  extends BaseDAO{
  StrUtils strUtils = new StrUtils();
  private String TABLE_NAME = "PRD_CLASS_MST";
  Connection con = null;
  ...
  public PrdClsDAO() {
    ...
    public boolean insertIntoPrdClsMst(Hashtable ht) throws Exception
   {
     MLogger.log(1, this.getClass() + " insertIntoPrdClsMst()");
          ...
          MLogger.log(0,"######################### Exception :: insertIntoPrdClsMst() : ######################### \n");
   ...
   /**
    * method  : deletePrdClsId(String aLocGrpId)
    * description : Delete the existing record  for aPrdClsId
    * @param : String aPrdClsId
    ...
    */
     ...
     {
    MLogger.log(1, this.getClass() + " deletePrdClsId()");
   ...
   sql.append(" WHERE " + formCondition(ht) );
    ...
    deletePrdCls=updateData(con,sql.toString());
          ...
          MLogger.log(0,"######################### Exception :: deletePrdClsId() : ######################### \n");
          MLogger.log(0,""+ e.getMessage());
          MLogger.log(0,"######################### Exception :: deletePrdClsId() : ######################### \n");
          MLogger.log(-1,"");
          throw e;
 ...
 public boolean isExists(Hashtable ht) throws Exception {
  ...
  public boolean updatePrdClsId(String query, Hashtable htCondition, String extCond) throws Exception 
    {
   MLogger.log(1, this.getClass() + " updatePrdClsId()");
   boolean flag = false;
  java.sql.Connection con=null;
   // connection
   try
   {
      ...
      flag = updateData(con,sql.toString());
          ...
          MLogger.log(0,"######################### Exception :: updatePrdClsId() : ######################### \n");
          MLogger.log(0,""+ e.getMessage());
          MLogger.log(0,"######################### Exception :: updatePrdClsId() : ######################### \n");
          MLogger.log(-1,"");
          throw e;
...
public Map selectRow(String query,Hashtable ht) throws Exception {
  ...
  public ArrayList getPrdClsIdStartsWith(String aPrdClsId ) throws Exception {          
   ...
   boolean flag=false;
   //query
    String sQry = "SELECT PRD_CLS_ID,PRD_CLS_DESC,ISNULL(PRD_GRP_ID,'') as PRD_GRP_ID FROM "+ TABLE_NAME+" WHERE PRD_CLS_ID LIKE '"+aPrdClsId+"%'";
    MLogger.query(" "+sQry);
 ...
 //added by Samatha to retrive the Qty per Tray based on Prd_cls_is for Sku
