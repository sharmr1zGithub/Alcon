...
{
  public static final String TABLE_NAME="DESTN_MST";
  ...
  { 
   ...
   /**
    * method  : delete(Hashtable ht)
    * description : Delete the existing record  for Desination
    * @param : String aLocId
 ...
 //  MLogger.log( -1, this.getClass() + " select()");
   ...
   public ArrayList getDestStartsWith(String aDest ) throws Exception {          
   ...
   boolean flag=false;
   //query
    String sQry = "SELECT  "+MDbConstant.DESTINATION+","+MDbConstant.SHIP_TO+","+MDbConstant.TRAV_PFX+"  FROM "+ TABLE_NAME+" WHERE "+ MDbConstant.DESTINATION +" LIKE '"+aDest+"%'";
    MLogger.query(" "+sQry);
...
//     MLogger.log( -1, this.getClass() + " getDestStartsWith()");
   return  al;
 }
 
 
  public ArrayList getShip_To_StartsWith(String aShipTo ) throws Exception {          
   ...
   boolean flag=false;
   //query
    String sQry = "SELECT  "+MDbConstant.DESTINATION+","+MDbConstant.SHIP_TO+","+MDbConstant.TRAV_PFX+"  FROM "+ TABLE_NAME+" WHERE "+ MDbConstant.SHIP_TO +" LIKE '"+aShipTo+"%'";
    MLogger.query(" "+sQry);
