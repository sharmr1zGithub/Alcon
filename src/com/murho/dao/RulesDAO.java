...
public class RulesDAO extends BaseDAO
{
  ...
  public static final String TABLE_NAME = "RULES_MST";
  ...
  public boolean insertIntoRules(Hashtable ht) throws Exception
   {
     MLogger.log(1, this.getClass() + " insertIntoRules()");
          ...
          MLogger.log(0,"######################### Exception :: insertIntoRules() : ######################### \n");
          MLogger.log(0,""+ e.getMessage());
          MLogger.log(0,"######################### Exception :: insertIntoRules() : ######################### \n");
          MLogger.log(-1,"");
          throw e;
   ...
   public boolean deleteRules(java.util.Hashtable ht) throws Exception
   {
    MLogger.log(1, this.getClass() + " deleteRules()");
    ...
    try{
     ...
     deleteLocGrp=updateData(con,sql.toString());
          ...
          MLogger.log(0,"######################### Exception :: deleteRules() : ######################### \n");
          MLogger.log(0,""+ e.getMessage());
          MLogger.log(0,"######################### Exception :: deleteRules() : ######################### \n");
          MLogger.log(-1,"");
          throw e;
 ...
 public boolean isExists(Hashtable ht) throws Exception {
  ...
  boolean flag=false;
   ...
   public boolean updateRule(Hashtable htUpdate,Hashtable htCondition) throws Exception
     {
  ...
  public boolean updateRule(String query, Hashtable htCondition, String extCond) throws Exception 
    {
     MLogger.log(1, this.getClass() + " updateRule()");
     boolean flag = false;
     java.sql.Connection con=null;
     // connection
       try
       {
          ...
          System.out.println("UpdateLocAssignRule ::"+sql.toString());
    
          flag = updateData(con,sql.toString());
        } catch(Exception e) {
              MLogger.log(0,"######################### Exception :: updateRule() : ######################### \n");
              MLogger.log(0,""+ e.getMessage());
