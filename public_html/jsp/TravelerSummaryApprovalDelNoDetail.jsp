...
document.form1.action = "TravelerSummaryApprovalDelNoDetail.jsp";
//alert(MTID);
document.form1.submit();
}
...
String strIDELIVERY_ITEM=(String)session.getAttribute("IDELIVERYITEM");
String strIDELIVERY_FILENAME=(String)session.getAttribute("IDELIVERYFILENAME");
...
if(HiddenView.equalsIgnoreCase("Go")){
 try{
      ...
      invQryList=recvDAO.getReceiveTravelerDetailsById(alTransactionData);
...
else if(HiddenAprove.equalsIgnoreCase("View")){
 try{
...
<%@ include file="body.jsp"%>
  ...
  <FORM name="form1" method="post" action="TravelerSummaryApprovalDelNoDetail.jsp" >
  ...
  <TABLE border="0" width="80%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
          ...
          <TR>
		   <TH ALIGN="RIGHT" >&nbsp;</TH>
                      ...
                      <TD><INPUT name="ITEM"  readonly  type = "TEXT"   value="<%=ITEM%>"   "20"  MAXLENGTH=20>
  ...
  <TABLE WIDTH="80%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
       ...
       <TR bgcolor = "<%=bgcolor%>">
            <TD align="center" width="12%"><%=iIndex%></TD>
             ...
             <TD align="center"> <a href = "TravelerSummaryApprvDet.jsp?action=view&LOT=<%=(String)lineArr.get("LOT")%>&TRAVELER=<%=(String)lineArr.get("TRAVELER")%>&SKU=<%=(String)lineArr.get("SKU")%>")%><%=(String)lineArr.get("LOT")%></a></TD>
   ...
   <!--   <input type="button" value="Approve" onClick="javascript:return onApprove();"/></TD> -->
     <!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <TR>  <input type="button" value="Back" onClick="window.location.href='TravellerSummaryApproval.jsp'?HiddenView=Go&ITEM=<%=ITEM%>'">&nbsp-->
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <TR>  <input type="button" value="Back" onClick="window.location.href='TravellerSummaryApproval.jsp?action=GO&ITEM=<%=strIDELIVERY_ITEM%>&FILENAME=<%=strIDELIVERY_FILENAME%>'"> &nbsp
       <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <TR>  <input type="button" value="Back" onClick="goBackward();"> &nbsp-->
