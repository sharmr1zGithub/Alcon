...
var HiddenExport =document.form1.HiddenExport.value = "";
...
function onExport(MTID){
document.form1.HiddenExport.value = "ExportReport";
var ITEM    = document.form1.ITEM.value;
document.form1.ITEM.value;
document.form1.MTID.value=MTID;
document.form1.action = "TraySummaryExcel.jsp";
document.form1.submit();
}

function onShipment(MTID){
document.form1.HiddenExport.value = "ExportReport";
var ITEM    = document.form1.ITEM.value;
document.form1.ITEM.value;
document.form1.MTID.value=MTID;
document.form1.action = "Shipment.jsp";
document.form1.submit();
}
</script>
<title>Tray Summary</title>
</head>
...
String WHID ="",  ITEM = "", BATCH ="", BINNO ="", QTY ="",QTYALLOC ="";
String  PKTYPE ="",MTID="",fieldDesc="",actionApprove="",Export="";
String html = "";

String HiddenView="",HiddenAprove="",HiddenExport="";
...
HiddenExport    = strUtils.fString(request.getParameter("HiddenExport"));
Export = strUtils.fString(request.getParameter("Export"));

/* if (HiddenExport.equalsIgnoreCase("ExportReport"))
    {
       response.sendRedirect("TraySummaryExcel.jsp?PLANT="+PLANT+"&ITEM="+ITEM );
    }*/

if(HiddenView.equalsIgnoreCase("Go")){

 try{
      invQryList = pickingDAO.getTrayLabelSummary(PLANT,ITEM);
...
<FORM name="form1" method="post"  >
  ...
  <INPUT type="hidden" name="HiddenExport" value="">
  <br>
  <TABLE border="0" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
    <TR>
      <TH BGCOLOR="#000066" COLSPAN="11">
        <FONT color="#ffffff">TRAY LABEL SUMMARY</FONT>&nbsp;
      </TH>
    </TR>
  </TABLE>
  <br>
  <TABLE border="0" width="80%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
          ...
          <TR>
		   <TH ALIGN="RIGHT" >&nbsp;</TH>
                      <TD>&nbsp;</TD>
                      <TH ALIGN="RIGHT" >&nbsp;Outbound Traveler No:</TH>
                      <TD><INPUT name="ITEM" type = "TEXT" value="<%=ITEM%>" size="20"  MAXLENGTH=20>
                      <input type="button" value="Go" onClick="javascript:onGo();"/></TD>
  ...
  <TABLE WIDTH="80%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
   ...
   <!--   <input type="button" value="Approve" onClick="javascript:return onApprove();"/></TD> -->
      <TR>&nbsp;  <input type="button" value="Back" onClick="window.location.href='indexPage.jsp'">&nbsp
       <input type="button" value="Shipment" onClick="javascript:onShipment();">
       
   <% if(Export.equalsIgnoreCase("YES")){ %>
   
    <input type="button"  value="ExportReport" onClick="javascript:onExport();"/ > </td>        
      
   <%}else{ %>
   <input type="button" disabled="disabled" value="ExportReport" onClick="javascript:onExport();"/ > </td>     
    <%}%>
    </P>
