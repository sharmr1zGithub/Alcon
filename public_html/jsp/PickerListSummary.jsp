...
<html>
<head><script src="WMS_InboundFileGen_3.0\\public_html\\jsp\\js\\jquery.min.js"></script>
<script>
...
function SetChecked(val)
{
  ...
  // Function added by Ranjana to implement the functionality of Alt checkbox under ticket WO0000001221213
var start = null;
 function SetRangeCheck(event,index)
  {
		  						...
		  						{ 
									...
									var end = index;									
									 ...
									 {																		
										for( j=start; j<end; j++)
											{						
												document.form1.chkdDoNo[j].checked	= 1;
											}																					
									 }
									 else
									 {
...
function onRemove(){
	 if(form1.ITEM.value=="" || form1.ITEM.value.length==0)
	  ...
	  document.form1.action = "PickerListSummary.jsp";
	  document.form1.submit();  
	  }else {
	         return false;
	     }
...
<title>Picker List Summary</title>
</head>
...
/*if(HiddenRemove.equalsIgnoreCase("Remove")){
     ...
     try{
       ...
       response.sendRedirect("PickerListSummary.jsp?res="+fieldDesc+"");
        }
        else
        {
  ...
  <TABLE border="0" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
    <TR>
      <TH BGCOLOR="#000066" COLSPAN="11">
        <FONT color="#ffffff">Pick List Summary</FONT>&nbsp;
      </TH>
    </TR>
  </TABLE>
  <br>
  ...
  <TABLE WIDTH="100%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
	  ...
	  <tr bgcolor="navy">         
       ...
       %>
	       ...
	       <TR bgcolor = "<%=bgcolor%>">	           
	              <TD BGCOLOR="#eeeeee" align="CENTER"><font color="black">
	              <INPUT Type=Checkbox  style="border:0;background=#dddddd" name="chkdDoNo" value="<%=chkString%>" onClick="SetRangeCheck(event,<%=iIndex%>);"></font></TD>
