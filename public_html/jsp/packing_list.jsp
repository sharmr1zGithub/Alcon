...
if(HiddenView.equalsIgnoreCase("View")){
 try{
     ...
     //  fieldDesc=fieldDesc+ITEM;
      ...
      isupdated=shipDetDAO.UpdateGlobalPackingList(PLANT,TRAVELER);
...
System.out.println("HiddenAprove>>>>>>>>>>>>>>>>>>>>>>>>>>>>."+HiddenView);
 try{
    response.sendRedirect("packing_list_excel.jsp?HiddenView=GenerateExcel&TRAVELER="+TRAVELER+"&INVOICE="+INVOICE+"&ASN="+ASN+"&SHIP_TO="+SHIP_TO+"");
...
<FORM name="form1" method="post">
  ...
  <TABLE border="0" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
    <TR>
      <TH BGCOLOR="#000066" COLSPAN="11">
        <FONT color="#ffffff">Packing list</FONT>&nbsp;
      </TH>
    </TR>
  </TABLE>
  <br/>
  ...
  <TABLE WIDTH="90%" border="0" cellspacing="1" cellpadding="2" align="center">
    ...
    <% 
        ...
        strSub =strUtils.fString((String)lineArr.get("UOM"));
