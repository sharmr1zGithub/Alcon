...
<title>StockTransfer  Report</title>
</head>
...
if(action.equalsIgnoreCase("Go")){
 try{
     ...
     //  DIRTYPE="Stk_transfer";
        ...
        movQryList = movHisUtil.getMovHisList_stocktransfer(ht,fdate,tdate);
...
<FORM name="form1" method="post">
  ...
  <TABLE border="0" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
    <TR>
      <TH BGCOLOR="#000066" COLSPAN="20"><font color="white">StockTransfer Report</font></TH>
    </TR>
  </TABLE>
  <br>
  ...
  <TABLE WIDTH="80%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
    <TR BGCOLOR="#000066">
         <TH><font color="#ffffff" align="center">NO</TH>
         <TH><font color="#ffffff" align="left"><b>MOVTID</TH>
        ...
        <!-- <TH><font color="#ffffff" align="left"><b>FrLoc</TH>-->
       ...
       <%
         ...
         // trDate=(String)lineArr.get("CRAT");
          trDate= new DateUtils().getDatemmddyy((String)lineArr.get("CRAT"));
       ...
       %>
          ...
          <TR bgcolor = "<%=bgcolor%>">
            ...
            <!--  <TD align= "right"><%=(String)lineArr.get("TOLOC") %></TD> -->
            <TD align= "right"><%=qty%></TD>
           
			      <TD align= "right"><%=(String)lineArr.get("CRBY")%></TD>
              <TD align= "right"><%=trDate%></TD>
