...
<form method="post" name="form1">
  <table border="0" width="100%" cellspacing="1" cellpadding="0" align="center" bgcolor="#dddddd">
    <TR BGCOLOR="#000066" >
      <TH align="center"><font color="white">Delivery No.</font></TH>
...
<%
   ...
   List listQry =null;
    ...
    if(FILENAME.equals(""))
    {
     listQry = trHeadDAO.getTravellerHdrList(CibaConstants.cibacompanyName,ITEM);
     
    }
    else
    {
      listQry = trHeadDAO.getTravellerHdrList1(CibaConstants.cibacompanyName,ITEM,FILENAME);
      //  listQry = trHeadDAO.getTravellerHdrList1(CibaConstants.cibacompanyName,FILENAME);
