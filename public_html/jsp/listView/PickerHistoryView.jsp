...
<%
   ...
   try{
    List listQry = trHeadDAO.getPickerHistoryView(CibaConstants.cibacompanyName,REFNO);
    ...
    <TR bgcolor="<%=sBGColor%>">
      ...
      <a href="#" onClick="window.opener.form1.REFNO.value='<%=refno%>';window.close();"><%=refno%></td>
