...
%>
    <TR bgcolor="<%=sBGColor%>">
      <td class="main2"><a href="#" onClick="window.opener.form1.PRD_GRP_ID.disabled = true;window.opener.form1.PRD_GRP_ID.value='<%=sPrdGrpId1%>';window.opener.form1.PRD_GRP_ID1.value='<%=sPrdGrpId1%>';window.opener.form1.PRD_GRP_DESC.value='<%=sPrdGrpDesc1%>';window.opener.form1.NO_TRAY.value='<%=sTotTray%>';window.close();"><%=sPrdGrpId1%></a></td>
