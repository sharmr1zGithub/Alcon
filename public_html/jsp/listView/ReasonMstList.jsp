...
%>
    <TR bgcolor="<%=sBGColor%>">
      <td class="main2"><a href="#" onClick="window.opener.form1.ITEM_ID.disabled = true;window.opener.form1.ITEM_ID.value='<%=prdclsid%>';window.opener.form1.ITEM_DESC.value='<%=desc%>';window.opener.form1.ITEM_ID1.value='<%=prdclsid%>';window.close();"><%=prdclsid%></a></td>
