...
<%
    ...
    String ITEM = strUtils.fString(request.getParameter("ITEM"));
     ...
     mLogger.log("ITEM slip :"+ITEM + REFNO);
    String sBGColor = "";

   try{
    List listQry = trHeadDAO.get_ob_travel_for_Shiping(CibaConstants.cibacompanyName,ITEM,REFNO);
    for (int i =0; i<listQry.size(); i++){
    Map map = (Map) listQry.get(i);
    sBGColor = ((i == 0) || (i % 2 == 0)) ? "#FFFFFF" : "#dddddd";
    String trno     = (String) map.get("traveler_id");
