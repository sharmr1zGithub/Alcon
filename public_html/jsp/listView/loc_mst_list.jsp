...
<form method="post" name="form1">
  <table border="0" width="100%" cellspacing="1" cellpadding="0" align="center" bgcolor="#dddddd">
    <TR BGCOLOR="#000066" >
      ...
      <TH align="center"><font color="white">Space Remainig</font></TH>
...
<%
   ...
   try{
    ...
    sBGColor = ((i == 0) || (i % 2 == 0)) ? "#FFFFFF" : "#dddddd";
     ...
     String space_rem             = (String) map.get("SPACE_REM");
...
%>
    <TR bgcolor="<%=sBGColor%>">
      ...
      <a href="#" onClick="window.opener.form1.LOC_ID.value='<%=loc_id%>';window.opener.form1.LOC_ID1.value='<%=loc_id%>';window.opener.form1.LOC_DESC.value='<%=desc%>';window.opener.form1.LOC_GRP_ID.value='<%=locgrpid%>';window.opener.form1.SPACE_REM.value='<%=space_rem%>';window.close();"><%=loc_id%></td>
       <td align ="center" class="main2"><%=desc%></td>
       <td align ="center" class="main2"><%=locgrpid%></td>
        <td align ="center" class="main2"><%=space_rem%></td>
