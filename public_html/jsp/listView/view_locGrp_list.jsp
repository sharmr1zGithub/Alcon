...
%>
    <TR bgcolor="<%=sBGColor%>">
      <td class="main2"><a href="#" onClick="window.opener.form1.LOCGRP.value='<%=sLocGrpId1%>';window.close();"><%=sLocGrpId1%></a></td>
...
%>
   <TR>
    ...
    <TR>
      <TH COLSPAN="8" align="center"><a href="#" onclick="window.close();"><input type="submit" value="Close">