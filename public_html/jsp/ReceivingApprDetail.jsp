...
<FORM name="form1" method="post" action="ReceivingAprroval.jsp" >
  ...
  <TABLE WIDTH="80%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
       ...
       %>
          <TR bgcolor = "<%=bgcolor%>">
            <TD align="center" width="12%"><%=iIndex%></TD>
             <!--<TD align="center"> <a href = "ReceivingUpdate.jsp?action=view&MTID=<%=(String)lineArr.get("MTID")%>&LOT=<%=(String)lineArr.get("LOT")%>&LOT=<%=(String)lineArr.get("LOT")%>")%><%=(String)lineArr.get("MTID")%></a></TD>-->
             <TD align="center"> <a href = "ReceivingUpdate.jsp?action=view&MTID=<%=(String)lineArr.get("MTID")%>&LOT=<%=(String)lineArr.get("LOT")%>&LOT=<%=(String)lineArr.get("LOT")%>&RECEIVESTATUS=<%=(String)lineArr.get("RECEIVESTATUS")%>")%><%=(String)lineArr.get("MTID")%></a></TD>
             
             <TD align="center" width="13%"><%=(String)lineArr.get("LOT")%></TD>
             <TD align="center" width="13%"><%=(String)lineArr.get("ORDQTY")%></TD>
   ...
   <!--   <input type="button" value="Approve" onClick="javascript:return onApprove();"/></TD> -->
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <TR>  <input type="button" value="Back" onClick="window.location.href='ReceivingAprroval.jsp?HiddenView=Go&ITEM=<%=TRAVELER%>'"> &nbsp
    </P>
