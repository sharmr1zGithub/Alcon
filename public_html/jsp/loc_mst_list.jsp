...
%>
    <TR bgcolor="<%=sBGColor%>">
      ...
      <a href="#" onClick="window.opener.form1.LOC_ID.value='<%=loc_id%>';window.opener.form1.LOC_ID1.value='<%=loc_id%>';window.opener.form1.LOC_DESC.value='<%=desc%>';window.opener.form1.LOC_GRP_ID.value='<%=locgrpid%>';window.close();"><%=loc_id%></td>
