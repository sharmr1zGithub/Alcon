...
if(action.equalsIgnoreCase("Go")){
 try{
     ...
     //   if(_strUtils.fString(DIRTYPE).length() > 0)     ht.put("MOVTID",DIRTYPE);
        ...
        movQryList = movHisUtil.getMovHisList_stockAdjust(ht,fdate,tdate);
...
<FORM name="form1" method="post">
  ...
  <TABLE border="0" width="100%" cellspacing="0" cellpadding="0" align="center" bgcolor="#dddddd">
    <TR>
      <TH BGCOLOR="#000066" COLSPAN="20"><font color="white">Stock Adjustment Report</font></TH>
    </TR>
  </TABLE>
  <br>
  ...
  <TABLE WIDTH="80%"  border="0" cellspacing="1" cellpadding = 2 align = "center">
    <TR BGCOLOR="#000066">
         ...
         <TH><font color="#ffffff" align="left"><b>SKU</TH>
          ...
          <TH><font color="#ffffff" align="center">Movement</TH>
       ...
       <%
          ...
          trDate= new DateUtils().getDatemmddyy((String)lineArr.get("CRAT"));
	          int qty = Integer.parseInt((String)lineArr.get("QTY"));
          int iIndex = iCnt + 1;
       ...
       %>
          ...
          <TR bgcolor = "<%=bgcolor%>">
            ...
            <TD align= "left"><%=(String)lineArr.get("SKU") %></TD>
           
            <TD align= "left"><%=(String)lineArr.get("LOT") %></TD>
